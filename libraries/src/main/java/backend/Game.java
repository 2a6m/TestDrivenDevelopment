...
public class Game {
    ...
    private JSONObject CheckLogin(String pseudo, String password){
        ...
        try {
            JSONObject db = Utils.ReadDatabase(Utils.url+"/src/main/resources/playerDatabase.json");
    ...
    public void Save(){
        try{
            ...
            try (FileWriter files = new FileWriter(Utils.url+"/src/main/resources/playerDatabase.json"))
            {
